...
if [[ "$SKIP_DEPS" == "false" ]]; then
    ...
    npm install --no-save --force \
        @fuzzyos/clipboard-darwin-arm64@0.3.0 \
        @fuzzyos/clipboard-darwin-x64@0.3.0 \
        @fuzzyos/clipboard-linux-x64-gnu@0.3.0 \
        @fuzzyos/clipboard-linux-arm64-gnu@0.3.0 \
        @fuzzyos/clipboard-win32-x64-msvc@0.3.0 \
