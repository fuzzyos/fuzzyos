...
AUTH_FILE="$HOME/.fuzzy/agent/auth.json"
AUTH_BACKUP="$HOME/.fuzzy/agent/auth.json.bak"
...
export FUZZY_NO_LOCAL_LLM=1

# Unset API keys (see packages/fuzzy-ai/src/stream.ts getEnvApiKey)
